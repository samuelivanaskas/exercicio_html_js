...
function validaNumero(numerocampoA, numerocampoB) {
    (numerocampoB.valueAsNumber) > (numerocampoA.valueAsNumber)
        return numerocampoB.valueAsNumber > numerocampoA.valueAsNumber;
}
...
form.addEventListener('submit', function(e) {
    ...
    formEValido = validaNumero(numerocampoA, numerocampoB)
    if (formEValido) {
